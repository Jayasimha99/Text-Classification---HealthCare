...
common_unique #top 10 most frequent common words in categories.

#We already found the top 100 most frequent common terms in Third_step
unneccesary_words = c(corr.terms,common_unique) #terms to be removed, combined together
...
#2 master data sets for classifying categories and sub categories
master_data_cat= as.data.frame(cbind(df,previous_appointment,categories))
